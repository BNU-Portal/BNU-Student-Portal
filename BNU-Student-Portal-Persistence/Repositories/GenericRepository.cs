...
namespace BNU_Student_Portal_Persistence.Repositories
{
    public class GenericRepository<TEntity, TKey>(BNU_Student_Portal_DbContext context) : IGenericRepository<TEntity, TKey> where TEntity : BaseEntity<TKey>
    {
